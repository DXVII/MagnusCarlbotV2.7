...
public:
    ...
    virtual void SCSCL::SyncWriteVel(u8 ID[], u8 IDN, u16 Position, u16 Time[], u16 Speed);
    ...
    virtual void SCSCL::ReadPosMulti(u8 *ID, u8 IDN, s16 *pos);
    virtual s16 ReadVel(u8 ID, u8 *Err = NULL);// , Err not used
    ...
    virtual int ReadCur(u8 ID, u8 *Err = NULL); // NGB 30/11/20
