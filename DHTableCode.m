...
% joints
d5 = 0.10;      % actually a combo of d5 & d6
d4 = 0;
d3 = 0;
d2 = 0;
...
xcoord = [0.2 0.2 0.6 0.6 0.2];
ycoord = [-0.4 -0.8 -0.8 -0.4 -0.4];
...
%% Inverse Kinematics - Beginning Equations
...
% 
% % Find valid Equilibria
% 
% % Valid equilibria exist where velocity = 0 (derivative of position)
...
% fz = d1 - d5 + a3 * sin(th2 + th3) + a2 * sin(th2)
