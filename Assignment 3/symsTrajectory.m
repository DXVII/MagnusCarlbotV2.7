...
vel_AB =  a1 + a2 .* t + a3 .* t.^2;
vel_BC =  b1 + b2 .* t + b3 .* t.^2;
vel_CD =  c1 + c2 .* t + c3 .* t.^2;
...
% velocity
% f7 = 0 == subs(vel_AB, t, t0)      % begin vi = 0
f7 = VA == subs(vel_AB, t, t0)         
...
f12 = VD == subs(vel_CD, t, t3)
% f12 = 0 == subs(vel_CD, t, t3)      % end vf = 0
